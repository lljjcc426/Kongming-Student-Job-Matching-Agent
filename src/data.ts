...
export const studentProfile: StudentProfile = {
  ...
  experiences: [
    {
      title: "校园二手交易小程序产品负责人",
      evidence: "完成需求访谈、信息架构、原型设计和上线后数据复盘，推动月活提升 38%。",
      tags: ["用户研究", "原型设计", "数据复盘"],
    },
    {
      title: "省级数据分析竞赛二等奖",
      evidence: "使用 Python 与 SQL 清洗行为数据，构建用户分层模型并输出运营建议。",
      tags: ["Python", "SQL", "数据分析"],
    },
    {
      title: "互联网运营实习",
      evidence: "参与活动转化漏斗分析，沉淀日报模板和 A/B 测试记录。",
      tags: ["增长分析", "运营", "A/B 测试"],
    },
  ],
  resumeText:
...
export const jobs: Job[] = [
  ...
  },
  {
    ...
    responsibilities: ["维护校招活动节奏", "分析学生触达和转化数据", "协同业务部门提升候选人体验"],
