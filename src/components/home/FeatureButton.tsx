...
export default function FeatureButton({ icon: Icon, label, onClick }: FeatureButtonProps) {
  return (
    <button className="km-feature-button" type="button" onClick={onClick}>
      <svg className="km-feature-voltage" viewBox="0 0 234.6 61.3" preserveAspectRatio="none" aria-hidden="true" focusable="false">
        <defs>
          <filter id={`km-feature-glow-${label}`} x="-25%" y="-60%" width="150%" height="220%">
            <feGaussianBlur stdDeviation="1.8" result="coloredBlur" />
            <feTurbulence type="fractalNoise" baseFrequency="0.08" numOctaves="1" result="turbulence" />
            <feDisplacementMap in="SourceGraphic" in2="turbulence" scale="20" xChannelSelector="R" yChannelSelector="G" result="displace" />
            <feMerge>
      ...
      <span className="km-feature-dots" aria-hidden="true">
