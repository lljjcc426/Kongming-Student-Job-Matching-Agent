...
assert.match(nativeEvidenceService, /maxRedirects:\s*4/);
assert.match(nativeEvidenceService, /192\\\.168/);
...
assert.match(page, /本次会话使用外部模型增强/);
